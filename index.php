...
<!-- 				<div class="row"> -->
					<div class="col-md-8 col-md-offset-2 col-lg-10 col-lg-offset-2 inline-block" id="btnLien2">
						<div class="hidden-xs hidden-sm ">
							<div id="int">
 
								
										<a href="pages/SoinsInfirmiers.php" id="rond1" class="link-rond"  data-toggle="tooltip" data-placement="left" title="Soins Infirmiers">
											<img class="icon-rond button  " src="img/soinsiconA.png">
										</a>
									
										<a href="pages/ServicesAide.php" id="rond2" class="link-rond" data-toggle="tooltip" data-placement="top" title="Services d’aide à domicile">
											<img class="icon-rond button " src="img/soinsaideA.png">
										</a>
										<a href="pages/ServicesHome.php" class="link-rond" id="rond3" data-toggle="tooltip" data-placement="top" title="Service Home sweet home">
											<img class="icon-rond button hvr-grow" src="img/soinshomeA.png ">
										</a>										
										<a href="pages/ServicesRemplacement.php" class="link-rond" id="rond4" data-toggle="tooltip" data-placement="top" title="Services de remplacement
					d’infirmière indépendante">
											<img class="icon-rond " src="img/soinsremplacementA.png">
										</a>
										<a href="pages/PedicureMedicale.php" class="link-rond " id="rond5" data-toggle="tooltip" data-placement="right" title="Pedicure Medicale">
											<img class="icon-rond " src="img/soinspedicureA.png">
										</a>
							</div>
						</div>
<!-- 					</div> -->
