...
<head>
	...
	<body>
		...
		<!--fin header-->
			<!--<div class="container full-width backblue photoser" >
					<div class="row ">
						<img  src="../img/job.jpg" id="photo" class="img-responsive hidden-xs hidden-sm full-width" alt="">
			...
			<div class="container ">
					<div class="row col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<h2 class="red text-uppercase">Job</h2>
						<p>Nous recherchons actuellement des gardes malades, des aides soignante 
						et infirmières ayant le statut d'indépendant / indépendant complémentaire.</p>
					</div>
			</div>
